...
func newUserTableImpl(schemaName, tableName, alias string) userTable {
	var (
		...
		allColumns      = sqlite.ColumnList{IDColumn, CompanyIdColumn, EmailColumn, PasswordColumn}
		mutableColumns  = sqlite.ColumnList{CompanyIdColumn, EmailColumn, PasswordColumn}
	)
