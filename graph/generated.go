...
type MutationResolver interface {
	...
	DeleteJob(ctx context.Context, input model.DeleteJobInput) (*model1.Job, error)
	UpdateJob(ctx context.Context, input model.UpdateJobInput) (*model1.Job, error)
}
...
func (ec *executionContext) field_Mutation_deleteJob_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNDeleteJobInput2githubᚗcomᚋDaoVuDatᚋgraphqlᚋgraphᚋmodelᚐDeleteJobInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateJob_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateJobInput2githubᚗcomᚋDaoVuDatᚋgraphqlᚋgraphᚋmodelᚐUpdateJobInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Company_jobs(ctx context.Context, field graphql.CollectedField, obj *model1.Company) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Company().Jobs(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Job_date(ctx context.Context, field graphql.CollectedField, obj *model1.Job) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Job().Date(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Job_date(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Job",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Job_company(ctx context.Context, field graphql.CollectedField, obj *model1.Job) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Job().Company(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputUpdateJobInput(ctx context.Context, obj interface{}) (model.UpdateJobInput, error) {
	...
	fieldsInOrder := [...]string{"title", "description", "id"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
	...
	for i, field := range fields {
		...
		case "jobs":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Company_jobs(ctx, field, obj)
				if res == graphql.Null {
	...
	for i, field := range fields {
		...
		case "date":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Job_date(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) unmarshalNDeleteJobInput2githubᚗcomᚋDaoVuDatᚋgraphqlᚋgraphᚋmodelᚐDeleteJobInput(ctx context.Context, v interface{}) (model.DeleteJobInput, error) {
...
func (ec *executionContext) marshalNJob2ᚕᚖgithubᚗcomᚋDaoVuDatᚋgraphqlᚋᚗgenᚋmodelᚐJobᚄ(ctx context.Context, sel ast.SelectionSet, v []*model1.Job) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJob2ᚖgithubᚗcomᚋDaoVuDatᚋgraphqlᚋᚗgenᚋmodelᚐJob(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalNUpdateJobInput2githubᚗcomᚋDaoVuDatᚋgraphqlᚋgraphᚋmodelᚐUpdateJobInput(ctx context.Context, v interface{}) (model.UpdateJobInput, error) {
...
func (ec *executionContext) marshalOCompany2ᚕᚖgithubᚗcomᚋDaoVuDatᚋgraphqlᚋᚗgenᚋmodelᚐCompanyᚄ(ctx context.Context, sel ast.SelectionSet, v []*model1.Company) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCompany2ᚖgithubᚗcomᚋDaoVuDatᚋgraphqlᚋᚗgenᚋmodelᚐCompany(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
